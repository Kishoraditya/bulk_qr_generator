...
def generate_qr_codes_from_excel(excel_file, output_pdf, qr_size=75):
...
if __name__ == "__main__":
    ...
    output_pdf = "qr_codes75.pdf"
    
    # You can adjust QR size as needed
    generate_qr_codes_from_excel(excel_file, output_pdf, qr_size=75)
